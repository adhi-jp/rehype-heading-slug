 ...
 * @typedef {import('./types').HeadingLevel} HeadingLevel
 * @typedef {import('./types').HeadingElement} HeadingElement
 * @typedef {import('./types').DuplicateSlugHandling} DuplicateSlugHandling
 * @typedef {import('./types').InvalidSlugHandling} InvalidSlugHandling
 * @typedef {import('./types').ExistingIdHandling} ExistingIdHandling
 * @typedef {import('./types').RehypeHeadingSlugOptions} RehypeHeadingSlugOptions
 * @typedef {import('./types').RegexPatterns} RegexPatterns
 * @typedef {import('./types').ProcessingContext} ProcessingContext
 * @typedef {import('./types').ProcessingOptions} ProcessingOptions
 * @typedef {import('./types').ExplicitSlugResult} ExplicitSlugResult
 */
